...
- NEW 명령어
	...
	- ex)
	```java
	TypedQuery<UserDto> resultList = em.createQuery("SELECT o.member, o.product, o.orderAmount m.age FROM Order o").getResultList();
	```
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA1MTIyMTUzNCwtNzg4ODc2MzIsMTk1OT
