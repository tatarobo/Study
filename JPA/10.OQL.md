...
```
	...
	- em.createQuery()에 실행할 JPQL과 반환할 엔티티의 클래스 타입인 Member.class를 넘겨주고 getResultList() 메소드를 실행하면 JPA는 JPQL을 SQL로 변환해서 DB를
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg0ODMwMzAzNCw3MzA5OTgxMTZdfQ==
-->