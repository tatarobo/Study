...
- 스칼라 타입 프로젝션
	...
	```java
	Double username = em.createQuery("SELECT avg(o.orderAmount) FROM Order m", Double.class).getSingleResult();
	```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1ODIyNjg4NDksLTc4ODg3NjMyLDE5NT
kyMTQxOTAsMTUyMzAxMzAxOCw1MjMzMTEyNDgsLTIwNTY1MjQz
MjYsMzE3MzA3OTM4LDIwOTc4Mjg2MDIsNzMwOTk4MTE2XX0=
-->