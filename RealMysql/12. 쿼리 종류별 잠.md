...
* `FOR UPDATE`가 사용되면 select 쿼리는 snapshot을 이용한 읽기를 사용하지 못하기 때문에 consistent read가 무시된다.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzY5NTk1NzY1LC0xOTU1MzA2MTE2LDEzMj
czNTExMzcsMTczNDkyMjQzNV19
-->