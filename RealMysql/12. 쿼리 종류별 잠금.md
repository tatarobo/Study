...
| COMMIT |
|| COMMIT |
* 1번 트랜잭션 : A에 exclusive-record-lock 획득, B에 대한 exclusive-record-lock 댁
* 2번 트랜잭션 : B에 exclusive-record-lock 획득
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDYxNzY3NzA3LDE4NDUzNTExNjYsLTMzNz
k3MDI3NF19
-->