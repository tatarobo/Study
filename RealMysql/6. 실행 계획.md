...
* **Using index for group-by**
	...
	* GROUP BY에서 인덱스를 사용하기 위해선 인덱스 사용 요건을 갖춰야한다. 하지만 그 이전에 WHERE 절에서 사용하는 인덱스에 의해서도 사용 여부가 영향을 받는다.
		...
		* WHERE 절의 조건이 있으며, 검색을 위해 인덱스를 사용하는 경우
			* WHERE 조건절이 검색하는데 사용했던 인덱스를 GROUP BY처리가 다시 사용할 수 있을 때만 루즈 인덱스 스캔을 사용할 수 있다. (만약 둘의 사용하는 인덱스가 다르다면 WHERE 조건절의 인덱스를 사용하는 경향이 있다.)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjQ2NjUzNzUwLDYxNTg3ODI1NiwtMjAzNj
gzMTM1OSwtMTU5NDQzNDM3OSw0NTU3NDA2NTcsLTEzMTMzMTQw
MjAsMjk0NTU3NDU3LDUzNTIwNjg2NywxMDg1OTg2NjYsLTE4MT
U4MzM5MTQsMjAxNDE2Nzk1OCwtMTcwNzk4NTAzNCwtMTY4MDI2
NDgwMywtNzQyMTM2MDUzLC04OTEyNzQxNDcsMTUxNTk2NjU5MC
wxMzYyOTM2NTg4LDE0MTQ1MjYzNjUsMTMxNDMzMTI0OSwxODc5
OTk0NTUzXX0=
-->