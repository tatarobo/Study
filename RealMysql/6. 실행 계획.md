...
* **Full scan on NULL key**
	* col1 IN (SELECT col2 FROM ...) 과 같은 조건에서 col1이 NULL을 만나면 풀 테이블 스캔을 사용할 것이라
### 6.2.11 EXPLAIN EXTENDED(Filterd 칼럼)
### 6.2.12 EXPLAIN EXTENDED(추가 옵티마이저 정보)
### 6.2.13 EXPLAIN PARTITIONS(Partitions 칼럼)
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMDE5OTQ2NDAsMTA4NTk4NjY2LC0xOD
E1ODMzOTE0LDIwMTQxNjc5NTgsLTE3MDc5ODUwMzQsLTE2ODAy
NjQ4MDMsLTc0MjEzNjA1MywtODkxMjc0MTQ3LDE1MTU5NjY1OT
AsMTM2MjkzNjU4OCwxNDE0NTI2MzY1LDEzMTQzMzEyNDksMTg3
OTk5NDU1MywtMTQ5MDI0ODc2NCwtMTcyNzU3NDQ0MSwxNTQwOD
gxODQxLDEwNzcwMzYxMDgsLTEwNTkzODU0NCw4MjQ5ODUwOTcs
MTI5NDA2MDM3N119
-->