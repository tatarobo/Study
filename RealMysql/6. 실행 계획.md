...
* 만약  하나의 SELECT 문장 안엣거 여러 개으 ㅣ테이블을 조인하면 조인되는 테이블의 개수만큼 실행 꼐획 레코드가 출
### 6.2.2 select_type 칼럼
### 6.2.3 table 칼럼
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIyNDA5MTEyLC0xMzEzNzA1MDU0LC0xMD
c3NTU1MDMxLDE5OTUzNzc3NDYsMTk0ODU3NTA1NCwtMTgzOTM3
NjQyMF19
-->