...
* UPDATE 문장 처리 시 일치하는 레코드를 인덱스를 이용해 검색 할 때, 우선 인덱스만 비교해서 일치하는 레코드에 대해 배타적 잠금 수행, 그 후 나머지 조건을 비교해서 일치하지 않는 레코드는 즉시 잠그
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIyODczNjIzNCwtNjE2MjExOTksNDQ5MT
kzNzY5LDIwOTA2MzQ3MTUsMjA1ODI0MjU2NywtMTAzNDIwNTU0
NCwxNTgyNDE5MjMwXX0=
-->